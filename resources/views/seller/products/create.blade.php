        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    ...
                    <a href="{{ route('seller.products.index') }}" class="btn btn-sm btn-secondary product-header-link">
                        <i data-lucide="arrow-left" class="fs-16"></i> Back to Products
                    </a>
                </div>
            </div>
            <div class="card-body">
                {{-- AJAX submits the text fields first; image uploads are chunked separately with a multipart fallback --}}
                <form id="product-create-form" action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tab-content" id="productTabsContent">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Be specific — include brand, model, key feature</small>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Max 500 characters — shown in search result cards</small>
                                    ...
                                    <div class="mb-3" style="position:relative;">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="brand_search"
                                                   ...
                                                   autocomplete="off"
                                                   value="{{ old('brand_id') ? optional(\App\Models\Brand::find(old('brand_id')))->name : (isset($product) ? optional($product->brand)->name : '') }}">
                                            <button class="btn btn-outline-secondary" type="button" id="brand_clear"
                                                    title="Clear brand" style="display:none">
                                        ...
                                        <div id="brand_add_section" class="mt-2" style="display:none">
                                            ...
                                            <button type="button" id="brand_check_btn"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Helps buyers searching exact model codes</small>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div id="image-drop-zone"
                                            ...
                                            <small>JPEG, PNG, WEBP — max 5 MB each. First image becomes primary.</small>
                                            {{-- input sits inside the drop zone, covers it fully --}}
                                        ...
                                        <div id="image-upload-status" class="mt-2" style="display:none">
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                ...
                                                <span id="image-upload-label" class="small text-muted">Uploading images…</span>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-search">
                            <div class="alert alert-info d-flex gap-2 align-items-start mb-4">
                                <i data-lucide="info" class="fs-16 flex-shrink-0 mt-1"></i>
                                <div>
                                    <strong>Why this matters:</strong> These fields power the search engine.
                                    Buyers who search for synonyms, common misspellings, or use-case phrases
                                    ("gift for dad", "office chair under 50k") will find your product only if you fill these in.
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                               ...
                                               placeholder="e.g. wireless, noise-cancelling, over-ear, headphones, bluetooth">
                                        <small class="text-muted">
                                            Comma-separated keywords. These are <strong>visible</strong> to buyers as clickable filter chips.
                                        </small>
                                        @error('tags') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        <div id="tags-preview" class="mt-2 d-flex flex-wrap gap-1"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('search_keywords') is-invalid @enderror"
                                                  id="search_keywords" name="search_keywords" rows="3"
                                                  placeholder="sony headphones, xm5, noise canceling headphone, premium earphone…">{{ old('search_keywords') }}</textarea>
                                        <small class="text-muted">
                                            <strong>Not visible to buyers</strong> — only used by the search algorithm.
                                            Add synonyms, misspellings, alternate product names, and use-case phrases.
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('use_cases') is-invalid @enderror"
                                               id="use_cases" name="use_cases" value="{{ old('use_cases') }}"
                                               placeholder="e.g. gifting, office use, travel, gaming, outdoor, gym">
                                        <small class="text-muted">
                                            When or where is this product used? Helps match "gift for..." or "best for..." queries.
                                        </small>
                                        @error('use_cases') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_audience') is-invalid @enderror"
                                            ...
                                            <option value="men"      {{ old('target_audience') == 'men'      ? 'selected':'' }}>Men</option>
                                            <option value="women"    {{ old('target_audience') == 'women'    ? 'selected':'' }}>Women</option>
                                            <option value="kids"     {{ old('target_audience') == 'kids'     ? 'selected':'' }}>Kids / Children</option>
                                            <option value="unisex"   {{ old('target_audience') == 'unisex'   ? 'selected':'' }}>Unisex</option>
                                            <option value="business" {{ old('target_audience') == 'business' ? 'selected':'' }}>Business / Professional</option>
                                        </select>
                            ...
                            <div class="card bg-light border-0 mt-2">
                                <div class="card-body py-3">
                                    <h6 class="mb-2"><i data-lucide="lightbulb" class="fs-14 me-1 text-warning"></i> Tips for better search visibility</h6>
                                    <ul class="mb-0 small text-muted ps-3">
                                        <li>Think like a buyer — what would <em>they</em> type to find this?</li>
                                        <li>Add common misspellings (headfone, blutooth, earbuds/ear buds)</li>
                                        <li>Include gift-search phrases: "gift for boyfriend", "mother's day gift"</li>
                                        <li>Add local/Nigerian market terms alongside English terms</li>
                                        <li>Avoid keyword stuffing — focus on genuinely relevant terms</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div id="specs-container">
                                        @php
                                            ...
                                            $existingSpecs = isset($product) ? ($product->specifications ?? []) : [];
                        ...
                        <div class="tab-pane fade" id="tab-seo">
                            <div class="alert alert-secondary d-flex gap-2 align-items-start mb-4">
                                <i data-lucide="info" class="fs-16 flex-shrink-0 mt-1"></i>
                                <div class="small">
                                    SEO fields improve how your product appears in Google search results.
                                    If left blank, the product name and short description are used automatically.
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                               ...
                                               maxlength="160" placeholder="e.g. Sony WH-1000XM5 Wireless Headphones — Buy Online in Nigeria">
                                        <div class="d-flex justify-content-between mt-1">
                                            <small class="text-muted">Recommended: 50–60 characters</small>
                                            <small id="meta_title_count" class="text-muted">0 / 160</small>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                                  ...
                                                  maxlength="320"
                                                  placeholder="e.g. Buy the Sony WH-1000XM5 wireless noise-cancelling headphones online. Fast delivery across Nigeria.">{{ old('meta_description') }}</textarea>
                                        <div class="d-flex justify-content-between mt-1">
                                            <small class="text-muted">Recommended: 120–160 characters</small>
                                            <small id="meta_desc_count" class="text-muted">0 / 320</small>
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="border rounded p-3 bg-white">
                                        ...
                                        <div id="serp-desc" class="text-muted small mt-1" style="max-width:600px;">
                                            Your short description will appear here if no meta description is set.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-flex gap-2 align-items-center product-form-actions">
                        <button type="submit" id="submit-btn" class="btn btn-primary">
                            <i data-lucide="save" class="fs-16"></i> Create Product
                        </button>
...
document.getElementById('category_id').addEventListener('change', function () {
    ...
    if (!categoryId) { sub.innerHTML = '<option value="">Select Subcategory</option>'; return; }
    fetch(`/seller/categories/${categoryId}/subcategories`)
        ...
        .catch(() => sub.innerHTML = '<option value="">Error loading subcategories</option>');
});
    ...
    row.innerHTML = `
        ...
        <div class="input-group input-group-sm variant-price-input">
            ...
            <input type="number" class="form-control form-control-sm" name="variant_price_adjustments[]"
                   placeholder="0" step="0.01" title="Positive = add. Negative = subtract. Blank = no change.">
        </div>
...
document.getElementById('variants-builder').addEventListener('click', function(e) {
    if (e.target.closest('.remove-variant-group')) {
...
updateCounter('meta_description', 'meta_desc_count');

function updateSerp() {
    const title = document.getElementById('meta_title').value
        || (document.getElementById('name').value ? document.getElementById('name').value + ' — Your Store' : 'Product Name — Your Store');
        ...
        fetch('{{ route('seller.brands.store') }}', {
            ...
            if (data.status === 'created' || data.status === 'exists') {
                ...
                if (data.status === 'created') {
                    showFeedback(`<i data-lucide="check-circle" class="fs-13 me-1"></i> ${data.message}`, 'success');
                    lucide.createIcons();
                }
            } else {
                showFeedback(data.message || 'Unexpected error.', 'warning');
            }
        }).catch(() => showFeedback('Network error. Please try again.', 'danger'));
    }
...
(function () {
    const CHUNK_SIZE  = 3;
    const CHUNKED_URL = '{{ route("seller.products.images.chunked", ["product" => "__ID__"]) }}';
    ...
    // Clicking the zone opens the file picker — but only if the click is NOT
    // already on the hidden file input (to avoid double-trigger in some browsers)
    ...
    fileInput.addEventListener('change', () => {
        ...
        fileInput.value = ''; // reset so the same file can be re-added if removed
    });
    ...
    function setBadge(file, text, bgClass) {
        ...
        badge.style.display = '';
        if (bgClass) badge.style.background = bgClass === 'success' ? 'rgba(25,135,84,.8)' : 'rgba(220,53,69,.8)';
    }
    ...
    form.addEventListener('submit', async function (e) {
        ...
        submitStatus.textContent = 'Saving product…';

        // Step 1 — POST form fields (no files) as AJAX, expect JSON back
        const formData = new FormData(form);
        // Make sure no stray file input sneaks in
        formData.delete('images[]');

        let productId, redirectUrl;
        try {
            ...
            if (!res.ok) {
                ...
                if (json.errors) {
                    // Show errors inline — scroll to first invalid field
                    const firstKey = Object.keys(json.errors)[0];
                    const el = form.querySelector(`[name="${firstKey}"]`);
                    if (el) {
                        el.classList.add('is-invalid');
                        // Insert or update feedback div
                        ...
                        fb.textContent = json.errors[firstKey][0];
        ...
        // Step 2 — Upload images in chunks of CHUNK_SIZE
        let failed = 0;
        if (pendingFiles.length > 0) {
            ...
            const uploadUrl = CHUNKED_URL.replace('__ID__', productId);

            for (const chunk of chunks) {
                uploadLabel.textContent = `Uploading images… ${uploaded} / ${total}`;
        ...
        if (pendingFiles.length > 0) {
            ...
            if (failed > 0) {
                submitBtn.disabled = false;
                submitStatus.style.display = '';
                submitStatus.textContent = 'Product saved, but some images failed to upload. Please retry the failed ones.';
                alert(`Product was created, but ${failed} image${failed !== 1 ? 's' : ''} failed to upload. Please retry before leaving this page.`);
                return;
            }
        }
