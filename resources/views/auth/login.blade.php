...
<title>GenesisHub ¡ª Login</title>
...
/* Override theme section background */
...
.auth-card__logo-wrap {
    ...
    border: 1.5px solid rgba(113,78,50,.12);
    margin-bottom: 14px;
}
...
.auth-card__brand {
    ...
    color: #714e32; letter-spacing: -.01em;
...
.auth-input.is-invalid:focus { box-shadow: 0 0 0 3px rgba(229,62,62,.12); }
...
.auth-check__input {
    ...
    accent-color: #714e32; flex-shrink: 0;
}

.auth-check__label { font-size: 13.5px; color: #555e68; cursor: pointer; user-select: none; }

.form-forgot {
    font-size: 13.5px; font-weight: 600;
    color: #714e32; text-decoration: none; transition: color .2s;
}
          ...
          <div class="col-lg-6 col-xl-5 col-xxl-4 m-auto">
            <div class="auth-card">
              ...
              <form action="{{ route('login') }}" method="POST" novalidate>
                ...
                <div class="form-extras">
                  <div class="auth-check">
                    ...
                    <label class="auth-check__label" for="remember">Remember me</label>
                  </div>
              ...
              <div class="auth-foot">
                ...
                <p>Are you a seller? <a href="{{ route('seller.login.form') }}">Seller login</a></p>
              </div>
