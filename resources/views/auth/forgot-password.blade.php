...
{{-- Rendered by Fortify::requestPasswordResetLinkView() in FortifyServiceProvider --}}
<!DOCTYPE html>
...
<title>Forgot Password ¡X {{ config('app.name', 'GenesisHub') }}</title>
...
.auth-card__icon-wrap {
    ...
    background: rgba(113,78,50,.07); border: 1.5px solid rgba(113,78,50,.12);
    margin-bottom: 14px;
}
...
.auth-input {
    ...
    transition: border-color .2s, box-shadow .2s; -webkit-appearance: none; outline: none;
}
...
.btn-auth {
    ...
    width: 100%; height: 52px; background: #714e32; color: #fff;
    border: none; border-radius: 10px; font-size: 14.5px; font-weight: 600;
    font-family: 'Inter', sans-serif; cursor: pointer; letter-spacing: .025em;
      ...
      <div class="col-lg-6 col-xl-5 col-xxl-4 m-auto">
        <div class="auth-card">
          ...
          <div class="auth-card__header">
            ...
            <p class="auth-card__sub">Enter your email and we'll send you a link to reset your password.</p>
          </div>
          ...
          <div class="notice notice--success">
            ...
            <div>
              <p class="notice__title">Link sent!</p>
          ...
          <div class="notice notice--warning">
            ...
            <div>
              ...
              <p class="notice__text">
                This account was created using Google or Facebook. Please sign in using the same social login button you used when you registered.
              </p>
            </div>
          </div>
          @endif
