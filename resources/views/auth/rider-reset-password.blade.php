{{-- resources/views/auth/rider-reset-password.blade.php --}}
<!DOCTYPE html>
<html dir="ltr" lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Reset Password — Rider — {{ config('app.name', 'GenesisHub') }}</title>
      ...
      <div class="col-lg-6 col-xl-5 col-xxl-4 m-auto">
        <div class="auth-card">
          ...
          <div class="auth-card__header">
            ...
            <p class="auth-card__sub">Choose a strong new password for your rider account.</p>
          ...
          <form method="POST" action="{{ route('rider.password.update') }}">
            @csrf
